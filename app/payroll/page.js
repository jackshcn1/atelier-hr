    ...
    <div>
      ...
      {unmatchedCodes.length > 0 && (
        <div style={{ background: '#fff3cd', border: '1px solid #ffe08a', borderRadius: 6, padding: 10, marginBottom: 16 }}>
          <strong>Unmatched Petpooja employee codes (no employee has this as their Employee ID — add them, or update an existing employee's ID on their page):</strong> {unmatchedCodes.join(', ')}
        </div>
      )}
