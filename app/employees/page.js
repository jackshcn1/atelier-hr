...
const empty = {
  ...
  reporting_manager_id: '', petpooja_employee_code: '', standard_hours_per_day: 10,
    ...
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: 10 }}>
          ...
          <a href="/employees/deleted" style={{ alignSelf: 'center' }}>Deleted →</a>
      ...
      {showForm && (
        <form onSubmit={handleAdd} style={{
          ...
          <input placeholder="Petpooja employee code (for payroll import matching)" value={form.petpooja_employee_code}
            onChange={e => setForm({ ...form, petpooja_employee_code: e.target.value })} />
          <label>Standard hours/day (for payroll calc, default 10)
